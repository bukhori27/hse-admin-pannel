  ...
  <div class="flex-row align-items-center card">
    <div class="container-fluid">
      <b-row class="card-header">
        <div class="col-sm-6">
          <h3 class="card-title">List PIC Area</h3>
        </div>
      </b-row>
            ...
            <div class="col-12">
              <div class="card-tools float-left p-t-3">
                <div class="input-group input-group-sm">
                  <input type="text" class="form-control" placeholder="Search PIC Area" v-model="searchText">
          ...
          responsive="xs" :items="listing" :fields="fields" :current-page="currentPage" :per-page="perPage"
           :filter="filter" @filtered="onFiltered">
            ...
            <template slot="actions" slot-scope="row">
              <router-link  v-bind:to="'/user/edit-area?id=' + row.item.id"  data-original-title="View"><b-button variant="warning" style="border-radius: 20%"><i class="fas fa-pencil-alt"></i></b-button></router-link>
