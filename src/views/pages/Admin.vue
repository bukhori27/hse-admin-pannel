          ...
          responsive="xs" :items="listing" :fields="fields" :current-page="currentPage" :per-page="perPage"
           ...
           <template slot="id" slot-scope="row">
            ...
            <template slot="actions" slot-scope="row">
              <router-link  v-bind:to="'/user/edit-admin/?id=' + row.item.id" data-toggle="tooltip" data-original-title="View"><b-button variant="warning" style="border-radius: 20%"><i class="fas fa-pencil-alt"></i></b-button></router-link>
