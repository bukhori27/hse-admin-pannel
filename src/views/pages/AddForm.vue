  ...
  <div class="flex-row card">
    <div class="container-fluid">
      ...
      <b-row class="card-body">
        <div class="col-12">
          <b-input-group>
            <label style="width: 100%; font-weight:600">Name Form</label>
            <input type="text" v-model="nama" class="form-control mb-4 border-radius-8 border-left" placeholder="nama form">
          </b-input-group>
          <b-input-group>
            <label style="width: 100%; font-weight:600">Description</label>
            <textarea type="text" v-model="description" class="form-control mb-4 border-radius-8 border-left" placeholder="description" rows="15"/>
          </b-input-group>
  ...
  export default {
    ...
    methods: {
      submit () {
        ...
        axios.post(url.url_app + 'type_add', parameter, config).then(function (response) {
