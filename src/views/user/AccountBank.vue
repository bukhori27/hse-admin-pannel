    ...
    <div class="col-md-12 skema-left1 row">
      <div class="col-lg-12 col-md-12 col-sm-12 row npr">
        <div class="col-lg-12 col-md-12 col-sm-12 row sm-npr" style="padding: 0 0 10px 0; border-radius: 0 0 10px 10px; border: 1px solid black;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 row m-t-30 skema-left2" v-if="activedash ===''">
              <div class="col-lg-12 col-md-12 col-sm-12 row text-skema-top-sm m-t-60">
                <div class="col-lg-12 col-md-12 col-sm-12 fs16 tc"> Anda belum menambahkan Nomor Rekening yang akan anda gunakan
                </div>
              </div>
              <div class="col-lg-3 col-md-3 col-sm-3"></div>
              <div class="col-lg-6 col-md-6 col-sm-6 row text-skema-top-sm m-b-40">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 row m-t-30 skema-left2" v-if="activedash ==='ada'">
              <div class="col-lg-12 col-md-12 col-sm-12 row text-skema-top-sm m-t-60">
                <div class="col-lg-12 col-md-12 col-sm-12 fs16 tc"> Bank Transfer yang anda gunakan
                </div>
              </div>
              <div class="col-lg-1 col-md-1 col-sm-1"></div>
              <div class="col-lg-10 col-md-10 col-sm-10 row text-skema-top-sm m-b-40 m-t-20">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 tc xsplr mdplr sosmed">
                  <div style="border: 1px solid grey; padding:15px 0 30px 0;"> 
                    <span class="fs28 fw700">Ayo Modali dana di projek ini!</span>
                    <p> <span class="fs18">Masukkan Permodalan Anda</span></p>
                    <p> <span class="fs18">saldo wallet mu: 0</span></p>
                  </div> 
                </div> 
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 tc xsplr mdplr sosmed">
                  <div style="border: 1px solid grey; padding:15px 0 30px 0;"> 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 row m-t-30 skema-left2" v-if="activedash ==='next'">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 row text-skema-top-sm">
                ...
                <b-input-group>
                  <input type="text" v-model="name_account_bank" class="form-control mb-4" placeholder="Input Email">
                </b-input-group>
                ...
                <b-input-group>
                  <input type="text" v-model="nomor_rekening" class="form-control mb-4" placeholder="Input Email">
                </b-input-group>
      ...
      view_bank () {
        ...
        axios.post(url.url_app + 'bank_user_filter', parameter, config).then(function (response) {
          if (response.data.resultCode == 'OK') {
            let a = response.data.bank_user_list
            self.bank_user = a
